...
export const aiplEvents: AIPLEvent[] = [
  ...
  },
  {
    ...
    date: '2026-05-07',
    entries: [
      { name: 'Symphony',            project: 'AI-Based Food & Engagement Rec...', repoLink: 'https://github.com/madhurchouhan7/apl_symphony/releases/tag/1.0', points: 25 },
      { name: 'Cric-Ai',             project: 'Cric-Ai',                   repoLink: 'https://github.com/UthkarshMandloi/APL7.git',           points: 24 },
      { name: 'Pushpraj Singhal',    project: 'Live food order with match', repoLink: 'https://github.com/pushprajsinghal/live-food-order-with-live-match', points: 24 },
      { name: 'Devesh Talreja',      project: 'CricPersona-AI',            repoLink: 'https://github.com/devesh-talreja/cricpersona-ai',      points: 23 },
      { name: 'Factorials',          project: 'Fan Fuel',                  repoLink: 'https://github.com/RhythmSurana/APL_Project',           points: 22 },
      { name: 'Deepanshu Sagore',    project: 'Cric-OS',                   repoLink: 'https://github.com/DeepanshuSagore/Cric-OS',            points: 20 },
      { name: 'Munish Jain',         project: 'Cricket Persona AI Bot',    repoLink: 'https://github.com/munishhhh/Cricket-Persona-AI',       points: 20 },
      { name: 'Imaginary Thinkers',  project: 'fanfeast ai',               repoLink: '',                                                       points: 18 },
