...
export const aiplEvents: AIPLEvent[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'Rizwan Shaikh',       project: '',                          repoLink: 'https://github.com/Rizwan050505/APL-QUIZ-GDG',           points: 13 },
      ...
      { name: 'Rishabh Choudhary',   project: '',                          repoLink: 'https://github.com/rishabh25-maker/cricverse-arcade',    points: 8 },
